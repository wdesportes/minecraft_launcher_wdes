...
public class YggdrasilAuthenticationService extends BaseAuthenticationService {
    ...
    */
    private static final String BASE_URL = "https://launchers.wdes.fr/auth/";
    private static final URL ROUTE_AUTHENTICATE = Util.constantURL("https://launchers.wdes.fr/auth/authenticate.php");
    private static final URL ROUTE_REFRESH = Util.constantURL("https://launchers.wdes.fr/auth/refresh.php");
    private static final URL ROUTE_VALIDATE = Util.constantURL("https://launchers.wdes.fr/auth/validate.php");
    private static final URL ROUTE_INVALIDATE = Util.constantURL("https://launchers.wdes.fr/auth/invalidate.php");
    private static final URL ROUTE_SIGNOUT = Util.constantURL("https://launchers.wdes.fr/auth/signout.php");
    private static final String STORAGE_KEY_ACCESS_TOKEN = "accessToken";
    ...
    protected void logInWithPassword() throws AuthenticationException {
        ...
        Launcher.getInstance().println("Connection par nom d'utilisateur & mot de passe");
    ...
    protected void logInWithToken() throws AuthenticationException {
        ...
        Launcher.getInstance().println("Connection avec token d'accès");

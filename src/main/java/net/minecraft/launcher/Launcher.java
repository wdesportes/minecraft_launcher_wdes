...
import fr.wdes.launchers.ComponentMover;
...
public class Launcher {
    ...
    public Launcher(final JFrame frame, final File workingDirectory, final Proxy proxy, final PasswordAuthentication proxyAuth, final String[] args, final Integer bootstrapVersion) {
        ...
        println("Launcher WdesLauncher v (1.0) started on " + OperatingSystem.getCurrentPlatform().getName() + "...");
    ...
    public void ensureLoggedIn() {
        ...
        if(auth == null)
            ...
            try {
                println("Tentative de reconnection...");
                auth.logIn();
                try {
                    profileManager.saveProfiles();
                }

...
public class DynamicButton extends JButton implements MouseListener {
	...
	protected final AtomicReference<ResizingWorker> worker = new AtomicReference<ResizingWorker>(null);
	protected final FutureImage icon;
	protected final int hoverIncrease;
	protected final DynamicLabel underLabel;
	protected final TransparentButton remove;
	protected final String  userName;
	public DynamicButton( FutureImage icon, int hoverIncrease, String userName) {
		this.icon = icon;

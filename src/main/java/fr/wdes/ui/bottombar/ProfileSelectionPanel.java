...
public class ProfileSelectionPanel extends JPanel implements ActionListener, ItemListener, RefreshedProfilesListener {
    private static class ProfileListRenderer extends BasicComboBoxRenderer {
        @Override
        public Component getListCellRendererComponent(@SuppressWarnings("rawtypes") final JList list, Object value, final int index, final boolean isSelected, final boolean cellHasFocus) {
    ...
    private final JComboBox<Object> profileList = new JComboBox<Object>();
    private final JButton newProfileButton = new JButton("Nouveau Profil");
    private final JButton editProfileButton = new JButton("Editer le Profil");
	...
	public ProfileSelectionPanel(final Launcher launcher) {
        ...
        profileList.addItem("Chargement...");
    ...
    protected void createInterface() {
        ...
        add(new JLabel("Profil: "), constraints);
        constraints.gridx = 1;
    ...
    public void itemStateChanged(final ItemEvent e) {
        ...
        if(!skipSelectionUpdate && e.getItem() instanceof Profile) {
            ...
            try {
            	...
            	logger.warn("Couldn't save new selected profile", e1);
            }

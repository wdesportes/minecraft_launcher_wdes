...
import fr.wdes.versions.PartialVersion;
...
public abstract class VersionList {
    private static class RawVersionList {
    	protected final List<PartialVersion> versions = new ArrayList<PartialVersion>();
    	protected final Map<ReleaseType, String> latest = new EnumMap<ReleaseType, String>(ReleaseType.class);
    ...
    protected final Map<ReleaseType, Version> latestVersions = new EnumMap<ReleaseType, Version>(ReleaseType.class);
    ...
    public CompleteVersion addVersion(final CompleteVersion version) {
        if(version.getId() == null)
            throw new IllegalArgumentException("Impossible d'ajouter une version vide");
